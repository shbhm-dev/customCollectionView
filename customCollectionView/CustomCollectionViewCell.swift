...
//        contentView.backgroundColor = .systemRed
        ...
        title = makeTitleLabel(withText: "Cheese Maggi!", withSize: 20)
        postedOn = makeLabel(withText: "Posted By : Shubham")
        
        let postStackView: UIStackView = {
                        let stackView = UIStackView(arrangedSubviews: [self.title!, self.postedOn!])
        ...
        title?.leadingAnchor.constraint(equalTo: postStackView.leadingAnchor, constant: 10).isActive = true
